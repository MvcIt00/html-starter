      ...
      <div className="container mx-auto px-6 text-center z-10 relative">
        <div className="animate-fade-in-up">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="#contatti" className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 rounded-full text-lg font-semibold hover:shadow-2xl hover:shadow-blue-500/50 transform hover:scale-105 transition-all duration-300">
              Richiedi Preventivo
            </a>
            <a href="#servizi" className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-lg font-semibold hover:bg-white/20 transform hover:scale-105 transition-all duration-300">
              Scopri i Servizi
            </a>
          </div>
        </div>
